...
values ('cek_pengumuman_public_enabled', 'false', now())
...
using (
  key in (
    ...
    'berkas_results_published','essay_results_published','cek_pengumuman_public_enabled',
    'countdown_enabled','countdown_target','poster_url','panduan_url','twibbon_frame_url',
    'wa_channel_url','timeline_config','faq_enabled','faq_items','gelombang_config',
    'donasi_enabled','donasi_title','donasi_subtitle','donasi_amount',
    'apresiasi_kelas_link','apresiasi_kelas_tanggal','apresiasi_kajian_link',
    'apresiasi_kajian_tanggal','apresiasi_sertifikat_link','apresiasi_rekaman_link',
    'apresiasi_heading','apresiasi_description','apresiasi_kelas_title',
    'apresiasi_kelas_speaker','apresiasi_kelas_speaker_desc','apresiasi_kajian_title',
    'apresiasi_kajian_speaker','apresiasi_kajian_speaker_desc',
