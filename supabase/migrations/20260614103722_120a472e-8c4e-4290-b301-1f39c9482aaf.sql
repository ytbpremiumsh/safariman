-- Auto-lolos for self_funded participants on registration
...
-- Backfill: existing self_funded participants set to interview (Lolos)
UPDATE public.participants
SET status = 'interview'::participant_status, updated_at = now()
