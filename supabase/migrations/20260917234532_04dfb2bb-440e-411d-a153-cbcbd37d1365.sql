...
AS $function$
  ...
  WHERE NULLIF(BTRIM(p.essay_worthy), '') IS NOT NULL
    ...
    AND NULLIF(BTRIM(p.case_study_3), '') IS NOT NULL
    AND NULLIF(BTRIM(p.case_study_4), '') IS NOT NULL
    AND NULLIF(BTRIM(p.case_study_5), '') IS NOT NULL
    AND NULLIF(BTRIM(p.case_study_6), '') IS NOT NULL
    AND NULLIF(BTRIM(p.case_study_7), '') IS NOT NULL
