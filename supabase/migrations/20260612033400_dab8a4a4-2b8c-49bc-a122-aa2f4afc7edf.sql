...
RETURNS TABLE(
  ...
  cv_url text, photo_url text, twibbon_confirmed_at timestamp with time zone,
  payment_status text, paid_at timestamp with time zone,
  donation_status text, donation_paid_at timestamp with time zone,
