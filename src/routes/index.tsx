...
import galKabahMalamUrl from "@/assets/galeri-kabah-malam.jpg";
import galMadinahPayungUrl from "@/assets/galeri-madinah-payung.jpg";
import galKabahGrupUrl from "@/assets/galeri-kabah-grup.jpg";
import galJabalRahmahUrl from "@/assets/galeri-jabal-rahmah.jpg";
import galUmrohNovemberUrl from "@/assets/galeri-umroh-november.jpg";
import galTurkiyeHagiaUrl from "@/assets/galeri-turkiye-hagia.jpg";
import galMasjidQubaUrl from "@/assets/galeri-masjid-quba.jpg";
            ...
            <div className="mt-8 animate-fade-up" style={{ animationDelay: "0.3s" }}>
              <div className="hidden sm:flex flex-wrap items-center gap-3 max-w-md mx-auto lg:mx-0">
                <AffiliateLink
                  ...
                  to="/pendaftaran"
                  className="inline-flex items-center gap-2 rounded-full bg-emerald-deep text-white px-7 py-3.5 text-sm font-semibold shadow-[0_20px_40px_-15px_rgba(0,60,40,0.4)] hover:bg-emerald transition-colors"
                >
                  Daftar Sekarang <ArrowRight className="size-4" />
                </AffiliateLink>
                <Link
...
function Benefits() {
  const items = [
    ...
    { i: Award, t: "Sertifikat Nasional", d: "Sertifikat resmi untuk portofolio kamu.", variant: "gold" as const },
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <a href="https://wa.me/6287777834426" target="_blank" rel="noopener noreferrer" className="hover:text-emerald transition-colors">+62 877-7783-4426</a>
              </li>
              <li className="flex items-start gap-2.5">
