...
function Timeline() {
  const steps: { i: typeof ClipboardList; t: string; d: string; date: string; cta?: { label: string; to: "/pendaftaran" | "/twibbon" | "/berkas" | "/essay" } }[] = [
    ...
    { i: Megaphone, t: "Bagikan Twibbon & Poster", d: "Download frame & share di sosial media", date: "1 Juni – 5 Agustus 2026", cta: { label: "Buat Twibbon & Poster", to: "/twibbon" } },
    ...
    { i: ClipboardList, t: "Pengisian Essay & Studi Kasus", d: "Tahapan Seleksi Essay dan Studi Kasus", date: "1 Juni – 10 Agustus 2026", cta: { label: "Kirim Essay & Studi Kasus ", to: "/essay" } },
    ...
    { i: Users2, t: "Tes Kesiapan Awal", d: "Tes berbasis CBT (Computer-Based Test) untuk menyaring peserta yang akan lolos ke tahapan selanjutnya", date: "20 – 31 Agustus 2026" },
