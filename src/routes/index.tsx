...
function Timeline() {
  const steps: { i: typeof ClipboardList; t: string; d: string; date: string; cta?: { label: string; to: "/pendaftaran" | "/twibbon" | "/berkas" | "/essay" } }[] = [
    ...
    { i: ClipboardList, t: "Pengisian Essay & Studi Kasus", d: "Setelah tunaikan kontribusi, lanjut isi essay", date: "1 Juni – 10 Agustus 2026", cta: { label: "Kirim Essay", to: "/essay" } },
