  ...
  return (
    <section id="program" className="relative py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        ...
        {/* Consolation Benefit — semua peserta tetap dapat */}
        <div className="mt-16 relative overflow-hidden rounded-3xl border border-accent/30 bg-gradient-to-br from-card via-secondary/40 to-card shadow-soft animate-fade-up">
          <div className="absolute -top-12 -right-12 size-48 rounded-full bg-accent/15 blur-3xl" />
          <div className="absolute -bottom-12 -left-12 size-48 rounded-full bg-emerald/15 blur-3xl" />

          <div className="relative p-8 sm:p-10 lg:p-12 grid lg:grid-cols-[1fr,auto] gap-8 items-start">
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.3em] text-accent font-bold bg-accent/10 px-3 py-1.5 rounded-full">
                <Heart className="size-3.5" /> Untuk Semua Peserta
              </span>
              <h3 className="font-display text-3xl sm:text-4xl font-semibold mt-4 leading-tight">
                Walau belum lolos, kamu tetap{" "}
                <span className="text-gradient-gold">membawa pulang ilmu</span>
              </h3>
              <p className="mt-3 text-muted-foreground leading-relaxed">
                Setiap peserta yang menyelesaikan tahap berkas akan tetap menerima rangkaian kelas online & e-sertifikat sebagai
                bekal ibadah dan ukhuwah — terlepas dari hasil seleksi keberangkatan.
              </p>
              ...
              <div className="mt-7 grid sm:grid-cols-2 gap-4">
                <div className="bg-card border border-border rounded-2xl p-5 hover-lift">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                    Dari niat hingga tahallul — panduan lengkap manasik umrah bersama ustadz pembimbing,
                    plus e-sertifikat resmi.
                  </p>
                </div>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
                ...
                <span className="inline-flex items-center gap-1.5">
                  <CheckCircle2 className="size-3.5 text-emerald" /> Rekaman Permanen
                </span>
              </div>
            </div>

            <div className="hidden lg:flex flex-col items-center justify-center text-center bg-gradient-emerald rounded-2xl p-8 text-white shadow-emerald min-w-[200px]">
              <Sparkles className="size-8 text-accent mb-3" />
              <div className="font-display text-4xl font-semibold text-gradient-gold">100%</div>
              <div className="text-xs uppercase tracking-[0.2em] text-white/70 mt-1">Peserta dapat</div>
            </div>
          </div>
        </div>
      </div>
