...
const DEFAULT_QUICK_REPLIES: (QuickReply & { category?: string })[] = [
  // ===== UMUM =====
  {
    ...
    category: "Umum",
    message:
      "Wa'alaikumussalam warahmatullahi wabarakatuh Kak 🙏✨\n\nBarakallahu fiik, semoga Allah senantiasa menjaga Kakak dalam kebaikan 🤲\n\nSelamat datang di *Safar Iman* — program Umrah Gratis untuk anak muda berprestasi (kolaborasi *Hasanah Tour & Travel × Prestasi Kita*).\n\nSenang sekali Kakak berkenan menghubungi kami 😊 Ada yang bisa kami bantu, Kak? Silakan disampaikan ya, insyaAllah kami bantu semaksimal mungkin 🤍🕋",
  },
  {
    keyword: "tentang",
    ...
    category: "Umum",
    message:
      "Halo Kak, barakallahu fiik 🤍 terima kasih sudah tertarik dengan program kami ya~\n\nJadi *Safar Iman* itu program Umrah Gratis khusus anak muda berprestasi Kak, hasil kolaborasi *Hasanah Tour & Travel × Prestasi Kita*. Kami ingin membuka jalan bagi lebih banyak pemuda-pemudi Muslim untuk berkunjung ke Baitullah dan menjadi tamu Allah 🕋\n\nSelain ibadah umrah sesuai sunnah, Kakak juga akan terlibat di banyak kegiatan bermakna:\n\n• Ibadah Umrah bersama pembimbing 🤲\n• Sedekah Al-Qur'an di Masjidil Haram & Nabawi 📖\n• Berbagi makanan untuk jamaah di Makkah & Madinah 🍱\n• City Tour situs-situs bersejarah Islam 🏛️\n• Networking Nasional bareng pemuda inspiratif 🤝\n\nSemoga Allah pilih Kakak jadi salah satu tamu-Nya, aamiin 🤲🤍\nInfo lengkap: https://www.safariman.id",
  },
  {
    keyword: "syarat",
  ...
  },
  {
    ...
    category: "Umum",
    message:
      "Baik Kak, biar Kakak bisa pilih jalur yang paling sesuai, ada 3 pintu yang kami sediakan ya, insyaAllah semua berpahala 🤍\n\n1️⃣ *Fully Funded (Reguler)* — seleksi penuh Kak, umrah 100% gratis untuk peserta terpilih 🕋\n2️⃣ *Partial Funded* — 30 peserta terbaik berikutnya (dari jalur Fully Funded) dapat subsidi *Rp2.000.000/orang* 🎗️\n3️⃣ *Self Funded* — jalur mandiri tanpa seleksi ketat, kuotanya terbatas cuma *10 peserta* Kak, jadi segera dimantapkan niatnya ya 😊\n\nSemoga Allah pilihkan yang terbaik buat Kakak 🤲\nDetail: https://www.safariman.id",
  },
  ...
  },
  {
    ...
    category: "Pendaftaran",
    message:
      "Baik Kak, jadi setelah Kakak selesai daftar di https://www.safariman.id, sistem otomatis kirim *Kode Pendaftaran unik berformat HXP-XXXXXXXX* ke email & WhatsApp Kakak ya 📩\n\nKode ini amanah penting Kak, dipakai untuk:\n• Kirim berkas administrasi 📄\n• Kontribusi 💳\n• Essay & studi kasus ✍️\n• Cek tahapan & hasil seleksi ✅\n\nKalau belum ketemu, coba cek folder *Spam / Promosi* di email dulu ya Kak. Kalau tetap belum ada, kirim aja *nama lengkap + email pendaftaran* Kakak ke sini, insyaAllah kami bantu cekkan 🙏🤍",
  },
  {
    keyword: "sosmed",
    ...
    category: "Pendaftaran",
    message:
      "Siap Kak, ini akun-akun yang *wajib difollow* sebagai syarat pendaftaran ya, sekaligus biar Kakak dapat update ilmu & inspirasi seputar umrah 🤍\n\n📸 *Instagram:*\n• @safariman.id\n• @hasanah.tours.travel\n• @hasanah.hajiumrohsemarang\n• @prestasikita\n\n🎵 *TikTok:*\n• @safariman.id\n• @hasanah.tours.travel\n• @hasanah.hajiumrohsemarang\n• @prestasikita\n\nPastikan sudah kefollow semua ya Kak, biar aman pas verifikasi berkas 🙏 Jazakumullah khairan sudah mendukung dakwah ini ✨",
  },
  {
    keyword: "mandiri",
    ...
    category: "Pendaftaran",
    message:
      "Baik Kak, izin jelaskan soal jalur *Self Funded* ya 🕋\n\nJalur ini insyaAllah cocok kalau Kakak pengen berangkat bareng komunitas Safar Iman tanpa seleksi ketat, sekaligus tetap merasakan nuansa perjalanan yang penuh keberkahan:\n\n• Isi form pendaftaran di https://www.safariman.id\n• Bayar administrasi pendaftaran *Rp50.000*\n• Wajib follow Instagram & TikTok penyelenggara (@safariman.id, @hasanah.tours.travel, @hasanah.hajiumrohsemarang, @prestasikita)\n• *Kuotanya cuma 10 peserta ya Kak* — kalau penuh langsung ditutup, jadi kalau sudah mantap niatnya, disegerakan ya 🤲\n\nSemoga Allah mudahkan langkah Kakak ke Baitullah 🕋🤍\nLink pendaftaran: https://www.safariman.id/daftar-mandiri",
  },
  ...
  },
  {
    ...
    category: "Pendaftaran",
    message:
      "Baik Kak, ini jadwal keberangkatan *Safar Iman* ya ✈️🕋\n\n🛫 *Start Jakarta*\n📅 *29 November – 8 Desember 2026*\n\nSeluruh peserta Fully Funded yang terpilih insyaAllah berangkat bareng-bareng sesuai jadwal di atas ya Kak. Semoga Allah tuliskan nama Kakak sebagai salah satu tamu-Nya di Baitullah, aamiin ya Rabbal 'alamiin 🤲🤍\n\nInfo lengkap: https://www.safariman.id",
  },
  ...
  },
  {
    ...
    category: "Berkas",
    message:
      "Boleh Kak, untuk mastiin berkas Kakak sudah masuk atau belum, langsung cek aja di:\nhttps://www.safariman.id/cek-tahapan\n\nMasukkan *Kode Pendaftaran (HXP-XXXXXXXX)* Kakak ya, nanti sistem akan tampilkan tahapan mana saja yang sudah / belum diselesaikan ✅ Kalau ada kendala, jangan sungkan chat kami lagi ya Kak, semoga Allah mudahkan 🤲🤍",
  },
  ...
  },
  {
    ...
    category: "Essay",
    message:
      "Boleh banget Kak, ini beberapa tips dari kami biar essay-nya makin oke, sekaligus insyaAllah bernilai ibadah ✨\n\n• Awali dengan bismillah dan luruskan niat karena Allah 🤲\n• Tulis pakai bahasa Kakak sendiri ya, hindari copy-paste 🙏\n• Ceritakan pengalaman nyata yang spesifik, jangan terlalu umum\n• Sampaikan niat & motivasi ibadah dengan tulus\n• Jelaskan rencana kontribusi Kakak setelah pulang umrah untuk umat\n• Perhatikan ejaan & tanda baca ya Kak\n\nEssay ini pintu utama seleksi lho Kak, jadi luangkan waktu buat nulis dengan baik, dibarengi doa 🤲 Semoga Allah bukakan jalannya, aamiin 🤍",
  },
  ...
  // ===== PEMBAYARAN =====
  {
    ...
    category: "Pembayaran",
    message:
      "Siap Kak, cara menunaikan kontribusinya insyaAllah mudah kok, ikutin aja ya 💳🤍\n\n1. Buka halaman kontribusi: https://www.safariman.id/kontribusi\n   (atau lewat https://www.safariman.id/cek-tahapan)\n2. Klik tombol *Bayar* — nanti Kakak diarahkan ke halaman Mayar\n3. Pilih metode pembayaran (QRIS, VA Bank, e-wallet, dll.) sesuai yang paling nyaman buat Kakak\n4. Selesaikan pembayarannya, semoga jadi sedekah yang berbuah keberkahan 🤲\n\nStatus otomatis kebarui maksimal 5 menit setelah pembayaran berhasil ya Kak ✅ Kalau lebih dari itu belum update, chat kami lagi ya. Jazakumullah khairan Kak 🤍",
  },
  {
    keyword: "bukti-bayar",
  ...
  },
  {
    ...
    category: "Pembayaran",
    message:
      "Baik Kak, ini rincian nominal kontribusinya ya, biar Kakak bisa pilih yang paling pas 💰\n\n📌 *Fully Funded — Reguler:* GRATIS 🎉\n📌 *Fully Funded — Gelombang 1 (Fast Track):* Rp20.000\n📌 *Fully Funded — Gelombang 2 (Fast Track):* Rp50.000\n📌 *Kontribusi Tahap Essay & Studi Kasus:* Rp100.000\n📌 *Self Funded — Administrasi Pendaftaran:* Rp50.000\n\nSemua kontribusi peserta insyaAllah digunakan untuk kegiatan Safar Iman, berbagi makanan, dan *sedekah Al-Qur'an di Makkah & Madinah* — jadi setiap huruf yang dibaca dari mushaf itu insyaAllah jadi pahala jariyah Kakak juga 🤍🕋",
  },
  ...
  // ===== TAHAPAN SELEKSI =====
  {
    ...
    message:
      "Boleh Kak, cek tahapan seleksi (Berkas, Essay, TKA, Interview) bisa langsung di:\nhttps://www.safariman.id/cek-tahapan\n\nMasukin *Kode Pendaftaran (HXP-XXXXXXXX)* Kakak ya. Hasil tiap tahap muncul setelah diumumkan resmi. Sambil menunggu, perbanyak doa & istighfar ya Kak 🤲 semoga Allah luluskan yang terbaik, aamiin 🤍",
  },
  {
    keyword: "seleksi",
  ...
  },
  {
    ...
    category: "Tahapan Seleksi",
    message:
      "Siap Kak, untuk cek hasil seleksi bisa langsung buka:\nhttps://www.safariman.id/cek-hasil\n\nMasukin *Kode Pendaftaran (HXP-XXXXXXXX)* Kakak ya. Hasilnya baru tampil setelah pengumuman resmi dari tim Safar Iman, dan pengumuman juga disiarkan di kanal resmi kami.\n\nApapun hasilnya, yakin Allah sudah tuliskan yang terbaik ya Kak. Rezeki umrah tak akan tertukar 🤲🤍",
  },
  ...
  },
  {
    ...
    category: "Kontribusi",
    message:
      "Boleh Kak, izin share kegiatan detail selama program *Safar Iman* ya 🕋\n\nJadi bukan cuma umrah aja Kak, kami padukan ibadah sesuai sunnah dengan kegiatan berbagi & pembelajaran biar setiap langkah Kakak bernilai ibadah:\n\n🕋 Ibadah Umrah sesuai sunnah Rasulullah ﷺ\n📖 Sedekah Al-Qur'an di Masjidil Haram & Nabawi\n🏛️ City Tour situs bersejarah Islam\n🍱 Berbagi Makanan untuk jamaah (Makkah & Madinah)\n🤝 Networking Nasional pemuda Muslim inspiratif\n🎓 Campus Tour & pembelajaran\n\nInsyaAllah jadi pengalaman spiritual yang bermakna dan penuh keberkahan buat Kakak 🤍\n\nInfo lengkap: https://www.safariman.id",
  },
  ...
  // ===== LAINNYA =====
  {
    ...
    category: "Lainnya",
    message:
      "Boleh Kak, pertanyaan umum sudah kami rangkum di halaman FAQ ya:\nhttps://www.safariman.id/faq\n\nCoba Kakak cek dulu, siapa tahu jawabannya udah ada di sana biar lebih cepat 🙏 Kalau masih ada yang kurang jelas, jangan sungkan chat kami lagi ya, insyaAllah kami bantu 🤍",
  },
  {
    keyword: "twibbon",
  ...
  },
  {
    ...
    category: "Lainnya",
    message:
      "Yuk Kak, gabung *WhatsApp Channel Safar Iman* biar Kakak nggak ketinggalan update info program, tips seleksi, kajian singkat & motivasi harian 🤍\n\nLink channelnya bisa Kakak cek di https://www.safariman.id ya. Barakallahu fiik 🕋🤲",
  },
  {
    keyword: "kontak",
    label: "Kontak Admin",
    category: "Lainnya",
    message:
      "Baik Kak, Kakak bisa menghubungi admin Safar Iman lewat WhatsApp ini ya, jam operasional kami *09.00–17.00 WIB, Senin–Jumat* 🙏\n\nDi luar jam itu, pesan Kakak tetap kami baca kok, dan insyaAllah kami balas secepatnya begitu admin online. Jazakumullah khairan sudah bersabar ya Kak 🤍✨",
  },
  {
    keyword: "terima",
    label: "Penutup",
    category: "Umum",
    message:
      "Sama-sama Kak, dengan senang hati 🤍 Jazakumullah khairan katsira sudah menghubungi kami ✨\n\nSemoga Allah mudahkan setiap langkah Kakak menuju *Safar Iman*, diberi keistiqamahan, dan dituliskan sebagai tamu-Nya di Baitullah, aamiin ya Rabbal 'alamiin 🤲🕋\n\nJangan sungkan chat kami lagi kalau ada yang perlu ditanyakan ya Kak 😊\nWassalamu'alaikum warahmatullahi wabarakatuh.",
  },
];
