...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Safar Iman — Umrah Gratis untuk Generasi Muda Indonesia" },
      { name: "description", content: "Program Umrah Gratis Fully Funded untuk anak muda Indonesia. Hasanah x Prestasi Kita — Leadership, Ibadah, City Tour, Wakaf & Islamic Journey Experience." },
      { name: "author", content: "Safar Iman" },
      { property: "og:title", content: "Safar Iman — Umrah Gratis untuk Generasi Muda Indonesia" },
      { property: "og:description", content: "Program Umrah Gratis Fully Funded untuk anak muda Indonesia. Hasanah x Prestasi Kita — Leadership, Ibadah, City Tour, Wakaf & Islamic Journey Experience." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Safar Iman — Umrah Gratis untuk Generasi Muda Indonesia" },
      { name: "twitter:description", content: "Program Umrah Gratis Fully Funded untuk anak muda Indonesia. Hasanah x Prestasi Kita — Leadership, Ibadah, City Tour, Wakaf & Islamic Journey Experience." },
