...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    icon: FileText,
    actor: "Peserta",
    desc: "Lengkapi data berkas pendukung sesuai instruksi di halaman berkas.",
    details: [
      "Login menggunakan Kode Pendaftaran di halaman /berkas.",
      "Isi link identitas diri, sertifikat, portofolio, serta data pengalaman & skill.",
      "Kirim berkas untuk diverifikasi tim Safar Iman.",
    ],
    route: "/berkas",
    duration: "± 5 menit",
  },
