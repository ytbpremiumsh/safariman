...
const STEPS: Step[] = [
  ...
  {
    no: 8,
    title: "Leadership Discussion Session",
    icon: Users,
    actor: "Peserta",
    desc: "Sesi diskusi kelompok untuk menilai kepemimpinan, komunikasi, dan team-work peserta.",
    details: [
      "Dilaksanakan via Zoom / tatap muka sesuai jadwal.",
      "Peserta dibagi dalam kelompok kecil (5-8 orang).",
      "Diskusi studi kasus dengan moderator dari tim Safar Iman.",
      "Penilaian: leadership, public speaking, empati, kontribusi ide.",
    ],
